...
const plans = [
  {
    name: "Practice",
    description:
      "For candidates polishing their interview skills with the AI coach.",
    price: 0,
    yearlyPrice: 0,
    ...
    includes: [
      "Free includes:",
      "Unlimited solo mock interviews",
      "AI-generated questions",
      "Voice + transcript feedback",
      "Resume-tailored sessions",
  ...
  },
  {
    name: "Recruiter",
    description:
      "For hiring teams running live AI-driven interviews on Google Meet.",
    price: 49,
    yearlyPrice: 399,
    ...
    includes: [
      ...
      "Live AI interviewer in Meet",
      "Reusable agent personas",
      "Per-candidate resume questions",
      "Live recruiter control panel",
      "Auto-generated structured feedback",
    ],
  },
  {
    name: "Enterprise",
    description:
      "For large teams with SSO, custom voices, and unlimited interviews.",
    price: 299,
    yearlyPrice: 2499,
    ...
    includes: [
      ...
      "Self-hosted bot infrastructure",
      "Custom voice + persona library",
      "Analytics + ATS integrations",
  ...
  return (
    ...
    >
      ...
      <article className="text-center mb-6 pt-32 max-w-3xl mx-auto space-y-2 relative z-50">
        ...
        >
          From solo practice to enterprise hiring — pick the plan that fits.
        </TimelineContent>
      ...
      <div className="grid md:grid-cols-3 max-w-5xl gap-4 py-6 mx-auto px-4 md:px-0">
